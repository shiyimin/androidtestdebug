...
public class Directory {
	...
	private static List<WeakReference<INotifyDirectoryChanged>> mListeners;
	...
	public static void initializeDirectory(INotifyDirectoryChanged listener) {
		...
		if (mListeners == null) {
			mListeners = new ArrayList<WeakReference<INotifyDirectoryChanged>>();
		}

		mListeners.add(new WeakReference<INotifyDirectoryChanged>(listener));
	}
	...
	public static void createNewCategory(String categoryName,
		...
		for (WeakReference<INotifyDirectoryChanged> listener : mListeners) {
			INotifyDirectoryChanged obj = listener.get();
			if ( obj != null ) {
				obj.addingNew(category);
			}
		}
	}
}