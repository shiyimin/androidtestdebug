...
public class MainActivity extends Activity implements ActionBar.TabListener {
	...
	class OnDirectoryChanged implements INotifyDirectoryChanged {
		@Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.addNewCategory:
        	Directory.createNewCategory("新条目", 
        			new DirectoryEntry("红色气球", R.drawable.red_balloon),
        			new DirectoryEntry("绿色气球", R.drawable.green_balloon));
        	return true;
